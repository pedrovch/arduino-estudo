...
#define echoPin 13 // echo (recebe)
#define trigPin 3 // trig (envia)
...
Ultrasonic ultrasonic(trigPin, echoPin);//inicalizando os pinos do sensor
...
void hcsr04(){
  ...
  distancia = (ultrasonic.Ranging(CM));//recebe o valor da distania media
